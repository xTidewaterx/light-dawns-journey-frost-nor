      ...
      <main className="relative mx-auto flex w-full max-w-7xl flex-col gap-8 lg:gap-10">
          ...
          <section className="grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
            ...
            >
              {!editing ? (
                ...
                <>
                  <p className="text-xs uppercase tracking-[0.32em] text-slate-500">Redigeringsmodus</p>
            ...
            <div
              ...
              style={{ borderColor: activeTheme.border }}
            >
              <p className="text-xs uppercase tracking-[0.32em] text-slate-500">Oversikt</p>
              <h2 className={`${roboto.className} mt-2 text-2xl font-semibold text-slate-900`}>Kontostatus</h2>
              <p className="mt-2 text-sm text-slate-600">
              ...
              <div className="mt-6 grid grid-cols-2 gap-3">
                ...
                <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                  <div className="text-xs uppercase tracking-[0.24em] text-slate-500">Modus</div>
                  <div className="mt-2 text-sm font-semibold text-slate-700">{editing ? 'Redigerer' : 'Viser'}</div>
                </div>
                <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                  <div className="text-xs uppercase tracking-[0.24em] text-slate-500">Status</div>
                  <div className="mt-2 text-sm font-semibold text-emerald-700">Aktiv</div>
                </div>
              </div>
            </div>
          </section>
        ...
        {!user && (
          <section className="mx-auto w-full max-w-3xl rounded-3xl border border-slate-200 bg-white/95 p-6 shadow-[0_14px_34px_rgba(15,23,42,0.08)] sm:p-8">
            <p className="text-xs uppercase tracking-[0.32em] text-slate-500">Profiltilgang</p>
            <h1 className={`${roboto.className} mt-2 text-2xl font-semibold text-slate-900`}>Min Profil</h1>
        ...
        {user && (
          <section className="rounded-3xl border border-slate-200 bg-white/95 p-6 shadow-[0_14px_34px_rgba(15,23,42,0.08)] sm:p-8">
            <p className="text-xs uppercase tracking-[0.32em] text-slate-500">Skaperverktoy</p>
            <h2 className={`${roboto.className} mt-2 text-2xl font-semibold text-slate-900`}>Produktverksted</h2>
          ...
          <section className="grid gap-8 xl:grid-cols-2">
            <div className="rounded-3xl border border-slate-200 bg-white/95 p-6 shadow-[0_14px_34px_rgba(15,23,42,0.08)] sm:p-8">
              <div className="mb-5 flex items-center justify-between gap-3">
                <h2 className={`${roboto.className} text-2xl font-semibold text-slate-900`}>Dine Produkter</h2>
            ...
            <div className="rounded-3xl border border-slate-200 bg-white/95 p-6 shadow-[0_14px_34px_rgba(15,23,42,0.08)] sm:p-8">
              <div className="mb-5 flex items-center justify-between gap-3">
                <h2 className={`${roboto.className} text-2xl font-semibold text-slate-900`}>Dine Favoritter</h2>
        ...
        <section className="rounded-3xl border border-slate-200 bg-white/90 p-4 shadow-[0_14px_34px_rgba(15,23,42,0.08)] sm:p-6">
          <div className="mb-3 flex items-center justify-between">
            <div>
              <p className="text-xs uppercase tracking-[0.28em] text-slate-500">Studiovisning</p>
              <h2 className="mt-1 text-xl font-semibold text-slate-900">Ateliermodell forhandsvisning</h2>
            </div>
          </div>
